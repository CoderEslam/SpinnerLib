...
//}
android {
    namespace = "io.github.codereslam.spinner"
    compileSdk = 36
...
//    coordinates("io.github.codereslam", "spinner", "1.1.0")
//
...
mavenPublishing {
    // 👇 Library coordinates (artifact identifiers)
    coordinates("io.github.codereslam", "spinner", "1.1.2")
